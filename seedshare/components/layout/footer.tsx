        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/library" className="text-gray-600 hover:text-green-600">
                  Seed Library
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/knowledge" className="text-gray-600 hover:text-green-600">
                  Knowledge Hub
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/guides" className="text-gray-600 hover:text-green-600">
                  Growing Guides
                </Link>
              </li>
              <li>
                <Link href="/experts" className="text-gray-600 hover:text-green-600">
                  Expert Consultation
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/seeds-act" className="text-gray-600 hover:text-green-600">
            ...
            <div className="mt-4 flex items-center space-x-2 text-sm text-gray-600">
              ...
              <a href="mailto:support@seedshare.com" className="hover:text-green-600">
