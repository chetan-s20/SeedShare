...
CREATE POLICY "Public Access" ON storage.objects FOR SELECT USING (bucket_id = 'seed-images');

CREATE POLICY "Authenticated users can upload" ON storage.objects
    FOR INSERT WITH CHECK (bucket_id = 'seed-images' AND auth.role() = 'authenticated');
